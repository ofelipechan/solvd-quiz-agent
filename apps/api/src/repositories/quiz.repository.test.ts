  ...
  questions: [
    {
      ...
      weight: 50,
      options: [
        { text: "a", isCorrect: true, feedback: "a is right" },
        { text: "b", isCorrect: false, feedback: "b is wrong" },
        { text: "c", isCorrect: false, feedback: "c is wrong" },
        { text: "d", isCorrect: false, feedback: "d is wrong" },
      ],
    },
    {
      text: "question 2",
      ...
      options: [
        { text: "a", isCorrect: true, feedback: "a is right" },
        { text: "b", isCorrect: true, feedback: "b is right" },
        { text: "c", isCorrect: false, feedback: "c is wrong" },
        { text: "d", isCorrect: false, feedback: "d is wrong" },
      ],
    },
