...
An Agent Skill for identifying subdomains and suggesting bounded contexts in any codebase following Domain-Driven Design (DDD) Strategic Design principles.
...
Agent: [Uses skill to:]
1. Ask: Is it a competitive advantage?
...
- **All-Inclusive Model**: Trying to create a single global model
...
- **Unclear Boundaries**: Cannot determine which domain owns a concept
