...
- **Type**: Supporting (or Core if pharmacy is a differentiator)
...
- **Type**: Core if a differentiator, Supporting otherwise
...
- **Type**: Supporting (unless unique content is a differentiator)
...
- **Type**: Core (if the algorithm is a competitive advantage)
